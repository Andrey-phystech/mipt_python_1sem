...
def bananas(screen_0, color, x0, y0, kx, ky, flag_y): #рисует банан
    ...
    polygon ( surface, color, [(1.5,0), (3.3,0), (3.65,4.54), (7.74,11.5), (13.89,12.63), (22,11.18), (23.04,12.36), (19.42,16.58), (13.43,18), (8.75,17.11),
                               (2.9,13.5), (0.32,8.87), (0.06,6.24), (1.64,3.01)] ) #рисует банан по точкам
    polygon ( surface, BLACK, [(1.5,0), (3.3,0), (3.65,4.54), (7.74,11.5), (13.89,12.63), (22,11.18), (23.04,12.36), (19.42,16.58), (13.43,18), (8.75,17.11),
                               (2.9,13.5), (0.32,8.87), (0.06,6.24), (1.64,3.01)],1 ) #обводка банана
